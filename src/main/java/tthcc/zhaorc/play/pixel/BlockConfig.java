...
//            "<link rel=\"stylesheet\" href=\"/pixel/color.css?v=0012\"/>",
//            "<script src=\"/pixel/jquery-3.7.1.min.js\"></script>",
//            "<script src=\"/pixel/pixel-app.js?v=0012\"></script>"
            "<link rel=\"stylesheet\" href=\"../../color.css?v=0012\"/>",
            "<script src=\"../../jquery-3.7.1.min.js\"></script>",
            "<script src=\"../../pixel-app.js?v=0012\"></script>"
    );
